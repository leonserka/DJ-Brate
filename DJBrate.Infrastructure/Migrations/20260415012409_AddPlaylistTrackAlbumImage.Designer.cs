...
namespace DJBrate.Infrastructure.Migrations
{
    ...
    [Migration("20260415012409_AddPlaylistTrackAlbumImage")]
    partial class AddPlaylistTrackAlbumImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DJBrate.Domain.Entities.AiConversationMessage", b =>
                {
                    b.HasOne("DJBrate.Domain.Entities.MoodSession", "MoodSession")
            ...
            modelBuilder.Entity("DJBrate.Domain.Entities.AiMoodMapping", b =>
                {
                    b.HasOne("DJBrate.Domain.Entities.MoodSession", "MoodSession")
                        ...
                        .HasForeignKey("DJBrate.Domain.Entities.AiMoodMapping", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DJBrate.Domain.Entities.MoodSession", b =>
                {
                    b.HasOne("DJBrate.Domain.Entities.AiModelConfig", "AiConfig")
            ...
            modelBuilder.Entity("DJBrate.Domain.Entities.Playlist", b =>
                {
                    b.HasOne("DJBrate.Domain.Entities.MoodSession", "MoodSession")
                        .WithOne("Playlist")
                        .HasForeignKey("DJBrate.Domain.Entities.Playlist", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DJBrate.Domain.Entities.PlaylistTrack", b =>
                {
                    b.HasOne("DJBrate.Domain.Entities.Playlist", "Playlist")
